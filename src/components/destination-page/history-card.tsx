...
const HistoryCard: FunctionComponent<Props> = ({ destination, stateSupabase }) => {
    return (
        <div className="w-full flex flex-col justify-center items-center">
            <div className="w-20 h-20 border-[1px] border-primary/50 p-1 rounded-full">
                <p className="w-full h-full flex items-center justify-center bg-primary/50 rounded-full">
                    <i className="fa-solid fa-wand-magic-sparkles text-white"></i>
                </p>
            </div>
            <p className="w-[2px] mt-4 h-4 bg-primary/50" />
            <div className="relative w-full h-20 p-2 pr-4 border-[1px] border-b-0 border-secondary/10 rounded-lg flex">
                <div className="w-full h-full bg-primary/50 rounded-lg flex items-center justify-center text-white px-4">
                    {
                ...
                <div className="w-full h-full flex flex-col items-center justify-center text-center p-4">
                    {
                        stateSupabase.isLoading ? (
                            ...
                            destination && (
                                <p className="description">{destination.history}</p>
                            )
                        )
                    }
                </div>
