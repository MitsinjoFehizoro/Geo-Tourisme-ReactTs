...
const DescriptionCard: FunctionComponent<Props> = ({ destination, stateSupabase }) => {
    return (
        <div className="w-64 flex flex-col justify-center items-center">
            <div className="w-20 h-20 border-[1px] border-primary p-1 rounded-full">
                <p className="w-full h-full flex items-center justify-center bg-primary rounded-full">
                    <i className="fa-solid fa-wand-magic-sparkles text-white"></i>
                </p>
            </div>
            <p className="w-[1px] mt-4 h-4 bg-primary" />
            <div className="relative w-full h-20 p-2 pr-4 border-[1px] border-b-0 border-secondary/10 rounded-lg flex">
                <div className="w-full h-full bg-primary rounded-lg flex items-center justify-center text-white px-4">
                    {
