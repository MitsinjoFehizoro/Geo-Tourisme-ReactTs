...
const StyleImage: FunctionComponent = () => {
    return (
        <motion.div
            ...
            className="relative w-full md:w-10/12 lg:w-5/12 flex justify-center"
        >
            ...
            <motion.img variants={variantsImage_2} src={baobab} className="w-[35vw] h-[35vw] md:w-[25vw] md:h-[25vw] lg:w-[16vw] lg:h-[16vw] rounded-full absolute left-0 md:left-10 lg:left-0 bottom-0 border-4 md:border-8 border-background" />
