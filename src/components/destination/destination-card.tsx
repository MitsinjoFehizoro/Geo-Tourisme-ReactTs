    ...
    return (
        ...
        >
            ...
            <motion.div variants={variantsStandard} className="mt-6">
                <NavLink to={`destinations`} onClick={() => handleDestinationChoice(destination.id)} className="transition ease-in duration-200 w-36 pb-2 border-b-2 border-black text-sm text-center hover:text-primary hover:border-primary cursor-pointer">VOIR PLUS DE DETAIL</NavLink>
            </motion.div>
        </motion.div>
    )
}
