...
const GarantiCard: FunctionComponent<Props> = ({ title, description }) => {
    ...
    return (
        <div className="w-80 mb-14 flex flex-col items-center">
            <h2 className="w-48 pb-2 mb-2 inline text-center text-white border-b-2 border-background/50 uppercase">{title}</h2>
            <p className="truncature w-full text-background/80 text-center mt-2 mb-6">{description}</p>
